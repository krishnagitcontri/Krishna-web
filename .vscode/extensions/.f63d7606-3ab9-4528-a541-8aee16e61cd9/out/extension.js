			...
			<body>
				...
				(function() {
					...
					function showStarterText(){
						...
						const $el = $('<div class="code-block-input chatMessage recieved starter-text"><div class="by">BLACKBOX</div><div class="chatMessage-text">Hello, Blackbox AI Chat can answer coding questions. Below are recommendations to get the best out of BLACKBOX</div><ul>'+recommendations+'</ul><div class="chat-button-containber"><div style="cursor:pointer" class="btn-onboarding">Schedule Onboarding</div><div class="vscode-button white w-button btn-walkthrough">Discover More Features</div></div><br></div>')
